import {Col, FormInstance, message, Row, Tooltip, Upload, Button, Dropdown, Menu} from "antd";
import {ColumnHeightOutlined, ColumnWidthOutlined, FileImageOutlined, TagOutlined} from "@ant-design/icons";
import {PlusOutlined} from "@ant-design/icons";
import React, {useCallback, useEffect, useState, cloneElement, ReactElement} from "react";
        ...
        (
          <Col lg={6} xs={24}>
            <Tooltip title="Fit to Width">
              <Button size="small" shape="circle" className={fitToWidthSelectedClass} icon={<ColumnWidthOutlined/>}
        ...
        (
          <Col lg={6} xs={24}>
            <Tooltip title="Fit to Height">
              <Button size="small" shape="circle" className={fitHeightSelectedClass} icon={<ColumnHeightOutlined/>}
        ...
        (
          <Col lg={6} xs={24}>
            <Tooltip title="Assign to Thumbnail">
              <Button size="small" shape="circle" icon={<FileImageOutlined />}
        ...
        (
          <Col lg={6} xs={24}>
            <Tooltip title="Assign to Tag">
              <Button size="small" shape="circle" icon={<TagOutlined />}
