...
import { fetchLinkCreator, updateLinkCreator } from "services/DiscoClubService";
import LinkOrganizerDetail from "./LinkOrganizerDetail";

interface LinkOrganizerTabCreatorProps { }

const LinkOrganizerTabCreator: React.FC<LinkOrganizerTabCreatorProps> = () => {
    ...
    const onSaveRecord = async (record: any, setLoadingLocal: any) => {
        try {
            ...
            await updateLinkCreator(record)
            setDetails(false);
        } finally {
            setLoadingLocal(true)
        }
...
export default LinkOrganizerTabCreator;
