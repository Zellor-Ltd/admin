    ...
    const columns: ColumnsType<any> = [
      {
        ...
        render: (value: string, record: any, index: number) => (
          <Link to={location.pathname} onClick={() => handleEditLink(index, record)}>
            {value}
          </Link>
        ),
      },
      {
        ...
        width: '15%',
        sorter: (a, b): any => {
          if (a.description && b.description) return a.description.localeCompare(b.description as string);
      ...
      },
      {
        ...
        render: (_, entity: any, index: number) => (
          <>
            <Link
              onFocus={() => (directLinksIndex.current = directLinks.indexOf(entity))}
